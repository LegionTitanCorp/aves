...
class QuizAvesAndinas {
    ...
    // Ibis de la puna
{
    question: "¿Cuál es el nombre científico del Ibis de la puna?",
    options: ["Plegadis ridgwayi", "Phleocryptes melanops", "Fulica ardesiaca", "Falco sparverius"],
    correct: 0,
    explanation: "El nombre científico del Ibis de la puna es Plegadis ridgwayi."
},
{
    question: "¿En qué hábitat se encuentra principalmente el Ibis de la puna?",
    options: ["Bosques amazónicos", "Humedales altoandinos", "Playas arenosas", "Zonas urbanas"],
    correct: 1,
    explanation: "El Ibis de la puna habita en humedales altoandinos."
},

// Totorero
{
    question: "¿Cuál es el nombre científico del Totorero?",
    options: ["Phleocryptes melanops", "Lessonia oreas", "Anthus furcatus", "Anas georgica"],
    correct: 0,
    explanation: "El Totorero se conoce científicamente como Phleocryptes melanops."
},
{
    question: "¿Dónde suele construir sus nidos el Totorero?",
    options: ["En huecos de árboles", "En madrigueras", "Colgados entre totoras", "En playas abiertas"],
    correct: 2,
    explanation: "El Totorero construye nidos colgantes entre las totoras."
},

// Rascón plomizo
{
    question: "¿Cuál es el nombre científico del Rascón plomizo?",
    options: ["Pardirallus sanguinolentus", "Columba livia", "Athene cunicularia", "Agelasticus thilius"],
    correct: 0,
    explanation: "El Rascón plomizo se denomina Pardirallus sanguinolentus."
},
{
    question: "¿Qué característica distingue al Rascón plomizo?",
    options: ["Plumaje iridiscente", "Color plomizo y pico largo", "Alas amarillas", "Camuflaje en arenas"],
    correct: 1,
    explanation: "El Rascón plomizo tiene color plomizo y pico largo."
},

// Negrito
{
    question: "¿Cuál es el nombre científico del Negrito?",
    options: ["Lessonia oreas", "Calidris bairdii", "Falco sparverius", "Anthus furcatus"],
    correct: 0,
    explanation: "El Negrito corresponde al nombre científico Lessonia oreas."
},
{
    question: "¿En qué tipo de hábitat vive el Negrito?",
    options: ["Bosques tropicales", "Altitudes elevadas", "Zonas costeras", "Pantanos"],
    correct: 1,
    explanation: "El Negrito se adapta a altitudes elevadas y zonas rocosas."
},

// Gallareta andina
{
    question: "¿Cuál es el nombre científico de la Gallareta andina?",
    options: ["Fulica ardesiaca", "Anas georgica", "Agelasticus thilius", "Plegadis ridgwayi"],
    correct: 0,
    explanation: "La Gallareta andina se llama Fulica ardesiaca."
},
{
    question: "¿Qué característica tiene la Gallareta andina?",
    options: ["Pico blanco y patas lobuladas", "Alas amarillas", "Canto complejo", "Plumaje críptico"],
    correct: 0,
    explanation: "La Gallareta andina posee pico blanco y patas lobuladas."
},

// Cernícalo americano
{
    question: "¿Cuál es el nombre científico del Cernícalo americano?",
    options: ["Falco sparverius", "Athene cunicularia", "Anthus furcatus", "Columba livia"],
    correct: 0,
    explanation: "El Cernícalo americano tiene como nombre científico Falco sparverius."
},
{
    question: "¿Qué tipo de vuelo caracteriza al Cernícalo americano?",
    options: ["Planeo bajo", "Vuelo cernido", "Migración en bandadas", "Vuelo rasante sobre agua"],
    correct: 1,
    explanation: "El Cernícalo americano se caracteriza por su vuelo cernido."
},

// Paloma doméstica
{
    question: "¿Cuál es el nombre científico de la Paloma doméstica?",
    options: ["Columba livia", "Pardirallus sanguinolentus", "Calidris bairdii", "Agelasticus thilius"],
    correct: 0,
    explanation: "La Paloma doméstica corresponde a Columba livia."
},
{
    question: "¿Cuál es una característica de la Paloma doméstica?",
    options: ["Orientación excelente", "Alas amarillas", "Nido colgante", "Color plomizo"],
    correct: 0,
    explanation: "La Paloma doméstica es famosa por su excelente orientación."
},

// Playero de Baird
{
    question: "¿Cuál es el nombre científico del Playero de Baird?",
    options: ["Calidris bairdii", "Anas georgica", "Athene cunicularia", "Lessonia oreas"],
    correct: 0,
    explanation: "El Playero de Baird tiene como nombre científico Calidris bairdii."
},
{
    question: "¿Qué hábito migratorio tiene el Playero de Baird?",
    options: ["Migración corta", "Migración intermedia", "Migración larga", "No migra"],
    correct: 2,
    explanation: "El Playero de Baird realiza migraciones largas."
},

// Lechuza terrestre
{
    question: "¿Cuál es el nombre científico de la Lechuza terrestre?",
    options: ["Athene cunicularia", "Falco sparverius", "Anthus furcatus", "Anas georgica"],
    correct: 0,
    explanation: "La Lechuza terrestre se llama Athene cunicularia."
},
{
    question: "¿Dónde suele anidar la Lechuza terrestre?",
    options: ["En madrigueras", "En árboles huecos", "En juncales", "En playas abiertas"],
    correct: 0,
    explanation: "La Lechuza terrestre suele anidar en madrigueras."
},

// Bailarín chico
{
    question: "¿Cuál es el nombre científico del Bailarín chico?",
    options: ["Anthus furcatus", "Columba livia", "Calidris bairdii", "Fulica ardesiaca"],
    correct: 0,
    explanation: "El Bailarín chico corresponde al nombre científico Anthus furcatus."
},
{
    question: "¿En qué tipo de hábitat vive el Bailarín chico?",
    options: ["Tierras abiertas", "Bosques tropicales", "Humedales", "Áreas urbanas"],
    correct: 0,
    explanation: "El Bailarín chico habita principalmente en tierras abiertas."
},

// Pato jergón
{
    question: "¿Cuál es el nombre científico del Pato jergón?",
    options: ["Anas georgica", "Plegadis ridgwayi", "Agelasticus thilius", "Athene cunicularia"],
    correct: 0,
    explanation: "El Pato jergón se conoce científicamente como Anas georgica."
},
{
    question: "¿Qué color tiene el pico del Pato jergón?",
    options: ["Negro", "Rojo", "Amarillo", "Blanco"],
    correct: 2,
    explanation: "El Pato jergón se caracteriza por su pico amarillo."
},

// Varillero ala amarilla (macho)
{
    question: "¿Cuál es el nombre científico del Varillero ala amarilla (macho)?",
    options: ["Agelasticus thilius", "Falco sparverius", "Anthus furcatus", "Columba livia"],
    correct: 0,
    explanation: "El Varillero ala amarilla (macho) corresponde a Agelasticus thilius."
},
{
    question: "¿Qué característica destaca en el Varillero ala amarilla (macho)?",
    options: ["Alas amarillas", "Pico curvo", "Plumaje blanco", "Nido colgante"],
    correct: 0,
    explanation: "El macho destaca por sus alas amarillas visibles."
},

// Varillero ala amarilla (hembra)
{
    question: "¿Cuál es el nombre científico del Varillero ala amarilla (hembra)?",
    options: ["Agelasticus thilius", "Anas georgica", "Fulica ardesiaca", "Athene cunicularia"],
    correct: 0,
    explanation: "La hembra también corresponde a la especie Agelasticus thilius."
},
{
    question: "¿Qué característica resalta en el Varillero ala amarilla (hembra)?",
    options: ["Canto melodioso", "Pico rojo", "Plumaje iridiscente", "Orientación excelente"],
    correct: 0,
    explanation: "La hembra se distingue por su canto melodioso y su coloración más discreta."
}
